          ...
          <div>
            ...
            <div className="bg-gray-900/50 p-3 rounded-md space-y-2 max-h-32 overflow-y-auto">
              {sources.map((source, index) => source.web && source.web.uri && (
                <a key={index} href={source.web.uri} target="_blank" rel="noopener noreferrer" className="block text-xs text-red-400 hover:text-red-300 truncate" title={source.web.title || source.web.uri}>
