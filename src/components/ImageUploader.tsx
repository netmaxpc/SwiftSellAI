...
const ImageUploader: React.FC<ImageUploaderProps> = ({ onAnalyze, isAnalyzing }) => {
  ...
  const takePicture = async () => {
    ...
    // Camera functionality temporarily disabled for web testing
    console.log('Camera functionality would be available in mobile app');
    alert('Camera functionality is available in the mobile app version');
  }
